    ...
    return (<div className="flex w-full flex-col h-full">
            ...
            <div className="flex flex-col h-[20%] relative overflow-hidden px-5 py-2 rounded-lg">
                <div className="flex flex-row-reverse pb-2">
                    {/*<div className="h-3 absolute top-0 right-[5%] flex">*/}
                    {/*    <Switch id="necessary" className="bg-amber-950" defaultChecked />*/}
                    <Label htmlFor="airplane-mode" className="font-bold text-2 self-center ">채팅번역</Label>
                    <Switch
                        checked={enabled}
                        onChange={setEnabled}
                        className={`${enabled ? 'bg-gray-600 mr-1' : 'bg-gray-400 mr-1'}
